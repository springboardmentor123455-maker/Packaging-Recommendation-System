...
-- SQLite database structure for sustainable packaging recommendation system

-- Drop existing tables if they exist
DROP TABLE IF EXISTS packaging_recommendations;
DROP TABLE IF EXISTS materials_data;
...
CREATE VIEW high_sustainability_materials AS
SELECT 
    material_id,
    material_name,
    material_type,
...
CREATE VIEW cost_efficient_materials AS
SELECT 
    material_id,
    material_name,
    material_type,
...
CREATE VIEW material_statistics AS
SELECT 
    material_type,
    COUNT(*) as count,
