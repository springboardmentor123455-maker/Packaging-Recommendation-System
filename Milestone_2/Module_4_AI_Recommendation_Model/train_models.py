...
current_dir = os.path.dirname(os.path.abspath(__file__)) # Module 4
module_3_dir = os.path.join(os.path.dirname(current_dir), 'Module_3_ML_Dataset_Preparation') # Module 3
if module_3_dir not in sys.path:
    sys.path.append(module_3_dir)
